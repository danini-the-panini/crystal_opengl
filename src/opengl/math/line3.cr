module OpenGL
  class Line3
    ...
    def initialize(start_point = OpenGL::Vector3.new, end_point = OpenGL::Vector3.new)
    ...
    def closest_point_to_point_parameter(point, clamp_to_line)
      start_p = OpenGL::Vector3.new
      start_end = OpenGL::Vector3.new
