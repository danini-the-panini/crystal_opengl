...
module OpenGL
  class Vector4 < Vector
    def self.elements; { x: 0, y: 1, z: 2, w: 3 }; end
    def self.dimensions; 4; end

    def initialize(x = 0, y = 0, z = 0, w = 1)
      super [x.to_f32, y.to_f32, z.to_f32, w.to_f32]
    end
    ...
    def z=(value); @elements[2] = value.to_f32; end
    def w=(value); @elements[3] = value.to_f32; end
