module OpenGL
  class Triangle
    ...
    def initialize(a = OpenGL::Vector3.new, b = OpenGL::Vector3.new, c = OpenGL::Vector3.new)
      @a, @b, @c = a, b, c
    end
    ...
    def normal(target = OpenGL::Vector3.new)
      OpenGL::Triangle.normal(@a, @b, @c, target)
    end
    ...
    def barycoord_from_point(point, target = OpenGL::Vector3.new)
      OpenGL::Triangle.barycoord_from_point(point, @a, @b, @c, target)
    end

    def contains_point?(point)
      OpenGL::Triangle.contains_point?(point, @a, @b, @c)
    end
    ...
    def self.contains_point?(point, a, b, c)
      v1 = OpenGL::Vector3.new
      result = OpenGL::Triangle.barycoord_from_point(point, a, b, c, v1)
