...
module OpenGL
  class Box2
    ...
    def initialize(min = nil, max = nil)
      @min = min || OpenGL::Vector2.new(Float32::INFINITY, Float32::INFINITY)
      @max = max || OpenGL::Vector2.new(-Float32::INFINITY, -Float32::INFINITY)
    end
    ...
    def make_empty
      @min.x = @min.y = Float32::INFINITY
      @max.x = @max.y = - Float32::INFINITY
      self
    end
    ...
    def clamp_point(point, target = nil)
      result = target || OpenGL::Vector2.new
