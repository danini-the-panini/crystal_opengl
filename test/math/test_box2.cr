...
class TestBox2 < Minitest::Test
  ...
  def test_constructor
    ...
    a = OpenGL::Box2.new(zero2.clone, zero2.clone)
    assert_equal(zero2, a.min)
    assert_equal(zero2, a.max)

    a = OpenGL::Box2.new(zero2.clone, one2.clone)
    assert_equal(zero2, a.min)
  ...
  def test_set_from_points
    ...
    a.set_from_points([] of OpenGL::Vector2)
    assert(a.empty?)
  end
  ...
  def test_contains_box
    a = OpenGL::Box2.new(zero2.clone, zero2.clone)
    b = OpenGL::Box2.new(zero2.clone, one2.clone)
    c = OpenGL::Box2.new(one2.clone.negate, one2.clone)
  ...
  def test_get_parameter
    a = OpenGL::Box2.new(zero2.clone, one2.clone)
    b = OpenGL::Box2.new(one2.clone.negate, one2.clone)

    assert_equal(OpenGL::Vector2.new(0, 0), a.parameter(OpenGL::Vector2.new(0, 0)))
    assert_equal(OpenGL::Vector2.new(1, 1), a.parameter(OpenGL::Vector2.new(1, 1)))

    assert_equal(OpenGL::Vector2.new(0, 0), b.parameter(OpenGL::Vector2.new(-1, -1)))
    assert_equal(OpenGL::Vector2.new(0.5, 0.5), b.parameter(OpenGL::Vector2.new(0, 0)))
    assert_equal(OpenGL::Vector2.new(1, 1), b.parameter(OpenGL::Vector2.new(1, 1)))
  end
  ...
  def test_clamp_point
    ...
    assert_equal(OpenGL::Vector2.new(0, 0), a.clamp_point(OpenGL::Vector2.new(0, 0)))
    assert_equal(OpenGL::Vector2.new(0, 0), a.clamp_point(OpenGL::Vector2.new(1, 1)))
    assert_equal(OpenGL::Vector2.new(0, 0), a.clamp_point(OpenGL::Vector2.new(-1, -1)))

    assert_equal(OpenGL::Vector2.new(1, 1), b.clamp_point(OpenGL::Vector2.new(2, 2)))
    assert_equal(OpenGL::Vector2.new(1, 1), b.clamp_point(OpenGL::Vector2.new(1, 1)))
    assert_equal(OpenGL::Vector2.new(0, 0), b.clamp_point(OpenGL::Vector2.new(0, 0)))
    assert_equal(OpenGL::Vector2.new(-1, -1), b.clamp_point(OpenGL::Vector2.new(-1, -1)))
    assert_equal(OpenGL::Vector2.new(-1, -1), b.clamp_point(OpenGL::Vector2.new(-2, -2)))
  end
  ...
  def test_distance_to_point
    ...
    assert_equal(0, a.distance_to_point(OpenGL::Vector2.new(0, 0)))
    assert_in_delta(Math.sqrt(2), a.distance_to_point(OpenGL::Vector2.new(1, 1)))
    assert_in_delta(Math.sqrt(2), a.distance_to_point(OpenGL::Vector2.new(-1, -1)))

    assert_in_delta(Math.sqrt(2), b.distance_to_point(OpenGL::Vector2.new(2, 2)))
    assert_equal(0, b.distance_to_point(OpenGL::Vector2.new(1, 1)))
    assert_equal(0, b.distance_to_point(OpenGL::Vector2.new(0, 0)))
    assert_equal(0, b.distance_to_point(OpenGL::Vector2.new(-1, -1)))
    assert_in_delta(Math.sqrt(2), b.distance_to_point(OpenGL::Vector2.new(-2, -2)))
  end
  ...
  def test_is_intersection_box
    ...
    b.translate(OpenGL::Vector2.new(2, 2))
  ...
  def test_translate
    a = OpenGL::Box2.new(zero2.clone, zero2.clone)
    b = OpenGL::Box2.new(zero2.clone, one2.clone)
  	c = OpenGL::Box2.new(one2.clone.negate, zero2.clone)

    assert_equal(OpenGL::Box2.new(one2, one2), a.clone.translate(one2))
