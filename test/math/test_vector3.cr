...
class TestVector3 < Minitest::Test
  ...
  def test_add
    ...
    c = OpenGL::Vector3.new.add_vectors(b, b)
  ...
  def test_sub
    ...
    c = OpenGL::Vector3.new.sub_vectors(a, a)
  ...
  def test_length_length_sq
    a = OpenGL::Vector3.new(x, 0f32, 0f32)
    b = OpenGL::Vector3.new(0f32, -y, 0f32)
    c = OpenGL::Vector3.new(0f32, 0f32, z)
    d = OpenGL::Vector3.new
  ...
  def test_set_length
    ...
    a = OpenGL::Vector3.new(0f32, 0f32, 0f32)
  ...
  def test_project_on_vector
    a = OpenGL::Vector3.new(1f32, 0f32, 0f32)
    b = OpenGL::Vector3.new
    normal = OpenGL::Vector3.new(10f32, 0f32, 0f32)

    assert_equal(OpenGL::Vector3.new(1f32, 0f32, 0f32), b.copy(a).project_on_vector(normal))

    a.set(0f32, 1f32, 0f32)
    assert_equal(OpenGL::Vector3.new(0f32, 0f32, 0f32), b.copy(a).project_on_vector(normal))
  ...
  def test_project_on_plane
    a = OpenGL::Vector3.new(1f32, 0f32, 0f32)
    b = OpenGL::Vector3.new
    normal = OpenGL::Vector3.new(1f32, 0f32, 0f32)

    assert_equal(OpenGL::Vector3.new(0f32, 0f32, 0f32), b.copy(a).project_on_plane(normal))

    a.set(0f32, 1f32, 0f32)
    assert_equal(OpenGL::Vector3.new(0f32, 1f32, 0f32), b.copy(a).project_on_plane(normal))

    a.set(0f32, 0f32, -1f32)
    assert_equal(OpenGL::Vector3.new(0f32, 0f32, -1f32), b.copy(a).project_on_plane(normal))
  ...
  def test_reflect
    a = OpenGL::Vector3.new
    normal = OpenGL::Vector3.new(0f32, 1f32, 0f32)
    b = OpenGL::Vector3.new

    a.set(0f32, -1f32, 0f32)
    assert_equal(OpenGL::Vector3.new(0f32, 1f32, 0f32), b.copy(a).reflect(normal))

    a.set(1f32, -1f32, 0f32)
    assert_equal(OpenGL::Vector3.new(1f32, 1f32, 0f32), b.copy(a).reflect(normal))
  ...
  def test_angle_to
    a = OpenGL::Vector3.new(0f32, -0.18851655680720186f32, 0.9820700116639124f32)
    b = OpenGL::Vector3.new(0f32, 0.18851655680720186f32, -0.9820700116639124f32)

    assert_in_delta(a.angle_to(a), 0f32)
    assert_in_delta(a.angle_to(b), Math::PI)

    x = OpenGL::Vector3.new(1f32, 0f32, 0f32)
    y = OpenGL::Vector3.new(0f32, 1f32, 0f32)
    z = OpenGL::Vector3.new(0f32, 0f32, 1f32)
    ...
    assert_in_delta(Math::PI / 4f32, x.angle_to(OpenGL::Vector3.new(1f32, 1f32, 0f32)))
  end

  def test_lerp_clone
    a = OpenGL::Vector3.new(x, 0f32, z)
    b = OpenGL::Vector3.new(0f32, -y, 0f32)
