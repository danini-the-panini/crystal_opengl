...
class TestVector4 < Minitest::Test
  ...
  def test_add
    ...
    c = OpenGL::Vector4.new.add_vectors(b, b)
  ...
  def test_sub
    ...
    c = OpenGL::Vector4.new.sub_vectors(a, a)
  ...
  def test_dot
    a = OpenGL::Vector4.new(x, y, z, w)
    b = OpenGL::Vector4.new(-x, -y, -z, -w)
    c = OpenGL::Vector4.new(0f32, 0f32, 0f32, 0f32)
  ...
  def test_length_length_sq
    a = OpenGL::Vector4.new(x, 0f32, 0f32, 0f32)
    b = OpenGL::Vector4.new(0f32, -y, 0f32, 0f32)
    c = OpenGL::Vector4.new(0f32, 0f32, z, 0f32)
    d = OpenGL::Vector4.new(0f32, 0f32, 0f32, w)
    e = OpenGL::Vector4.new(0f32, 0f32, 0f32, 0f32)
  ...
  def test_set_length
    ...
    a = OpenGL::Vector4.new(0f32, 0f32, 0f32, 0f32)
  ...
  def test_lerp_clone
    a = OpenGL::Vector4.new(x, 0f32, z, 0f32)
    b = OpenGL::Vector4.new(0f32, -y, 0f32, -w)
